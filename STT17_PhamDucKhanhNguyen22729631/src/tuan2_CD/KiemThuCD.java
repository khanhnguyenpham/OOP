...
public class KiemThuCD 
{
	...
	public static void createDefaulCD() throws Exception {
		...
		CD s1 = new CD(20001, "Song Gio", "Jack", 12, 1400000);
		CD s2 = new CD(20004, "Bac Phan", "Jack", 13, 1900000);
		CD s3 = new CD(20006, "Noi nay co anh", "Son Tung MTP", 8, 800000);
		CD s4 = new CD(20003, "Them 1 lan dau", "HKT", 3, 500000);
		cdList.add(s1);
		cdList.add(s2);
		cdList.add(s3);
		cdList.add(s4);
